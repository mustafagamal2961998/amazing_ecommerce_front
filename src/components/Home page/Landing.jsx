...
const Landing = () => {
  return (
    <div className='w-full relative overflow-hidden flex justify-start gap-10 p-10 bg-gradient-to-tr from-[#8AD0C3] to-[#00B6A9]'>
        ...
        <Image 
            src={name1}
            alt='name1'
            className='w-full animate-move'
        />
        <Image 
            src={name2}
            alt='name2'
            className='w-1/4 animate-move'
        />
        <Image 
            src={name3}
            alt='name3'
            className='w-3/4 animate-move'
        />
        <Image 
            src={name4}
            alt='name4'
            className='w-2/4 animate-move'
        />
        <Image 
            src={name5}
            alt='name5'
