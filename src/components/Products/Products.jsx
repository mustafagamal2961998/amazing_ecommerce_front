import './style.css';
import { faArrowLeft, faCartPlus, faFilter, faHeart } from "@fortawesome/free-solid-svg-icons"
...
const products = await GET_PRODUCTS();
  return (
    <main className='flex items-start gap-5 max-md:flex-col max-md:items-center p-5'>
      <aside className='relative w-1/4 max-md:w-full p-5 shadow h-full flex flex-col gap-5 rounded-md mt-11'>
            ...
            <span className='price flex flex-col gap-2 items-start'>
                <p>السعر</p>
                <span className='w-full flex items-center gap-2'>
                    <input type='range' className='w-full' />
                </span>
            </span>
            <button className='w-1/4 p-1 bg-[#5E6DA8] text-white rounded-md mr-auto'>تطبيق</button>
