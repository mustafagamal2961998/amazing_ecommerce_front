...
const Navbar = () => {
  ...
  return (
    <nav className='flex flex-col relative z-50'>
        <div className={`h-[50px] p-5 flex ${pathname === '/products' ? 'flex-row' : 'flex-row-reverse'} justify-between items-center pb-5 pt-5 pr-[60px] pl-[60px]`}>
            <div className={`flex flex-row-reverse gap-3 items-center ${pathname !== '/products' && 'mr-auto'}`}>
        ...
        <div className='nav bg-gradient-to-br from-[#252B42] to-[#5E6DA8] h-[71px] p-5 flex flex-row justify-between pb-5 pt-5 pr-[60px] pl-[60px]'>
            <Link href='/'>
        ...
        { pathname === '/products' ?
            <span className='relative w-[15%]'>
                ...
                <FontAwesomeIcon icon={faSearch} className='w-[16px] h-[16px] text-gray-300 absolute left-5 top-[60%] -translate-y-2/4 -translate-x-2/4' />
            </span>
        :
