...
const Manufacturing = () => {
  return (
    <div className='manufacturing w-full min-h-screen p-14 bg-[#CAE4F2] flex flex-col items-center gap-4'>
        ...
        className='w-48'
        />
        <div className='w-[800px] h-[300px] text-center p-5 bg-[#17616642] rounded-2xl flex justify-center items-center'>
            <h2 className='text-3xl font-bold leading-relaxed z-10'>مرحباً بكم في قسم التصنيع للغير بشركة خلابة لتصنيع الملابس</h2>
        </div>
        <div className='w-full flex justify-evenly items-center'>
            <div className='flex flex-col gap-4'>
                ...
                className='w-48 h-fit shadow-md text-center font-bold rounded-xl p-4 text-white bg-[#375EF9] hover:bg-[#375ef9be] duration-200'
                >
                    طلب جديد
                </Link>
                <Link
                ...
                className='w-48 h-fit shadow-md text-center font-bold rounded-xl p-4 text-white bg-[#FF0000] hover:bg-[#ff0000b9] duration-200'
                >
                    متابعة الطلبات
                </Link>
            </div>
