  ...
  return (
    <div className='w-full flex flex-col items-start gap-8 font-bold'>
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات العميل</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-start gap-12 info-con'>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات الموديل</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-start gap-12 info-con'>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات القماش</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-between info-con'>
              <span className='flex items-center gap-2'>
                <p className='w-[250px]'>الخامة رقم 1</p>
                <p className='info'>دوبي سلاب</p>
              </span>
              <span className='flex items-center gap-2'>
                <p className='w-[120px]'>لون الخامة رقم 1</p>
                <p className='info w-8 h-8 rounded-full bg-[#FF0000]'></p>
              </span>
            </div>
            <div className='w-full flex justify-between info-con'>
              <span className='flex items-center gap-2'>
                <p className='w-[250px]'>الخامة رقم 2</p>
            ...
            <div className='w-full flex justify-between info-con'>
              <span className='flex items-center gap-2'>
                <p className='w-[250px]'>الخامة رقم 3</p>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات الباترون</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-start gap-12 info-con'>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات القص</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-start gap-12 info-con'>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات التصنيع</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-between info-con'>
              <span className='flex items-center gap-2'>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات الكي والتغليف</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-start gap-12 info-con'>
      ...
      <div className='w-full flex flex-col items-start'>
        <span className='p-2 font-bold flex justify-center items-center w-1/6 rounded-3xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>بيانات التخزين والشحن</span>
        <div className='w-full p-5 flex flex-col items-start gap-10 bg-[#D9D9D9D9] rounded-lg'>
            <div className='w-full flex justify-start gap-12 info-con'>
