...
const Storage = () => {
    ...
    return (
        <div className='relative w-full flex flex-col justify-start gap-6'>
            <span className='absolute -right-14 -top-14 p-2 font-bold flex justify-center items-center w-1/6 rounded-2xl rounded-tl-none rounded-br-none bg-[#176166] text-white'>التخزين</span>
            ...
            <span className='w-2/4 flex items-center gap-10'>
