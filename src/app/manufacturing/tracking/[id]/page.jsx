...
const page = (params) => {
  ...
  return (
    <div className='manufacturing w-full min-h-screen bg-[#CAE4F2] flex flex-col gap-4'>
        <Navbar />
        <div className='w-full flex flex-col items-center gap-4 p-14'>
            ...
            <ul className='w-1/5 max-md:w-full mt-auto ml-auto'>
                {stepsData.map(item => (
