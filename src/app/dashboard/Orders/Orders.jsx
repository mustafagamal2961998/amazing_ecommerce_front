          ...
          { orders ?
            <>
              <div className='grid grid-cols-5 gap-8 w-full'>
                <div className='p-3 w-[100%] h-[55px] flex items-center justify-start gap-3 rounded-3xl bg-[#FEF5A8] shadow-md'>
      ...
      <div className='flex flex-col justify-start gap-24 w-full'>
        <div className='p-5 border-[1px] border-[#F1F1F1] rounded-3xl flex items-center justify-between'>
          <div className='w-3/4 flex-col flex justify-start items-start gap-6 p-3'>
            ...
            <div className='flex justify-center items-center gap-36 mt-12 p-4 border-[1px] border-[#F1F1F1] rounded-3xl'>
              ...
              <span className='flex justify- items-start gap-5'>
                ...
                <span className='flex flex-col justify-center items-center gap-3'>
                  <p>المقاس</p>
                  <span className='text-center bg-[#5E6DA8] rounded-md text-white p-2'>
                    s
                  </span>
                </span>
              </span>
            ...
            <div className='flex justify-center items-center gap-36 p-4 border-[1px] border-[#F1F1F1] rounded-3xl'>
              <span className='flex items-center gap-2'>
                <Image src={itemImg} alt='item' className='w-[45px] h-[45px]' />
                <p>بدلة كاروهات</p>
              </span>
          ...
          <div className='w-1/4 h-full flex flex-col justify-center items-start gap-5 rounded-2xl relative order-status'>
            ...
            <span className='w-full flex justify-between gap-3 font-bold'>
                <input type='text' className='w-3/4 p-2 rounded-xl outline-none border-[1px] border-[#CCCCCC] placeholder:text-xs placeholder:font-light placeholder:text-[#CCCCCC]' placeholder='ادخل كود الخصم' />
                <button className='rounded-xl bg-[#5E6DA8] text-white p-3 w-1/4 font-light'>تطبيق</button>
            </span>
        ...
        <div className='flex flex-col items-start gap-5'>
          ...
          <div className='flex gap-8 min-w-[14%]'>
            <span className='flex flex-col justify- items-center gap-2'>
              <Image src={greenTickCircle} alt='done' className='w-[20px] h-[20px]' />
              <Image src={dots} alt='dots' className='w-[20px] h-[30px]' />
            </span>
          ...
          <div className='flex gap-8'>
            ...
            <span className='relative'>
              <Image src={loading} alt="loading" className="w-[50px] h-[50px] bg-white p-2 rounded-3xl" />
              <span className='flex justify-center items-center gap-1 absolute top-2/4 -translate-y-2/4 -translate-x-2/4 -right-1'>
