  ...
  return (
    <div className='flex flex-col items-start gap-4'>
        <Link href='/dashboard/settings' className='flex items-center gap-3'>
            <div className={`w-[270px] h-[150px] cursor-pointer select-none ${pathname === '/dashboard/settings' ? 'bg-[#00B6A9]' : 'bg-[#D9E1FF]'} rounded-2xl flex flex-col justify-center items-center gap-2`}>
        ...
        <Link href='/dashboard/settings/coins' className='flex items-center gap-3'>
            <div className={`w-[270px] h-[150px] cursor-pointer select-none ${pathname === '/dashboard/settings/coins' ? 'bg-[#00B6A9]' : 'bg-[#D9E1FF]'} rounded-2xl flex flex-col justify-center items-center gap-2`}>
        ...
        <Link href='/dashboard/settings/paymentMethods' className='flex items-center gap-3'>
            <div className={`w-[270px] h-[150px] cursor-pointer select-none ${pathname === '/dashboard/settings/paymentMethods' ? 'bg-[#00B6A9]' : 'bg-[#D9E1FF]'} rounded-2xl flex flex-col justify-center items-center gap-2`}>
        ...
        <Link href='/dashboard/settings/managers' className='flex items-center gap-3'>
            <div className={`w-[270px] h-[150px] cursor-pointer select-none ${pathname === '/dashboard/settings/managers' ? 'bg-[#00B6A9]' : 'bg-[#D9E1FF]'} rounded-2xl flex flex-col justify-center items-center gap-2`}>
        ...
        <Link href='/dashboard/settings/maintenance' className='flex items-center gap-3'>
            <div className={`w-[270px] h-[150px] cursor-pointer select-none ${pathname === '/dashboard/settings/maintenance' ? 'bg-[#00B6A9]' : 'bg-[#D9E1FF]'} rounded-2xl flex flex-col justify-center items-center gap-2`}>
        ...
        <Link href='/dashboard/settings/returnPolicy' className='flex items-center gap-3'>
            <div className={`w-[270px] h-[150px] cursor-pointer select-none ${pathname === '/dashboard/settings/returnPolicy' ? 'bg-[#00B6A9]' : 'bg-[#D9E1FF]'} rounded-2xl flex flex-col justify-center items-center gap-2`}>
