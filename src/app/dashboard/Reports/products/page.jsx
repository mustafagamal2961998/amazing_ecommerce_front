...
const ProductsReports = () => {
  ...
  const handleToDateChange = (date) => {
    if (date < fromDay) setFromDay(date);
    setToDay(date);
  };

  const data = [
    { name: 'بدل رجالي', total: 4000 },
    { name: 'بلوزة', total: 3000 },
    { name: 'جيبة', total: 2000 },
    { name: 'قميص', total: 2780 },
  ];
      ...
      <div className="w-full flex flex-col justify-start items-center">
        <div className="w-full p-10 flex justify-evenly items-center">
          ...
          <div className="flex flex-col items-start gap-5">
            <h2 className="font-bold">أكثر المنتجات مبيعاً</h2>
            <div className="p-5 rounded-2xl border-2 border-solid border-[#E1E7EC] h-[500px]">
              <BarChart
                width={400}
                height={450}
                data={data}
          ...
          {/* Search Pie Chart */}
          <div className="flex flex-col items-start gap-5">
            <h2 className="font-bold">أكثر المنتجات بحثاً</h2>
            <div className="p-5 rounded-2xl border-2 border-solid border-[#E1E7EC] h-[500px] flex justify-between items-center">
              <div className="flex flex-col gap-3">
                {searchData.map((item, index) => (
                  <span key={index} className="flex justify-between items-center gap-2">
                    <p>{item.name}</p>
                    <FontAwesomeIcon
                      icon={faCircle}
        ...
        <div className="w-full">
          ...
          <div className="overflow-x-auto sm:-mx-6 lg:-mx-8 w-full mt-10">
            ...
            {/* Report Actions */}
            <div className="p-3 flex justify-center items-center gap-10">
              <button className="w-fit p-3 bg-[#07932E] rounded-full flex items-center gap-5 shadow-xl">
                <p>طباعة التقرير</p>
                <Image src="/dashboard/printReport.svg" alt="print report" width={30} height={30} />
              </button>
              <button className="w-fit p-3 bg-[#FFC42D] rounded-full flex items-center gap-5 shadow-xl">
                <p>تنزيل التقرير</p>
                <Image src="/dashboard/download.svg" alt="download report" width={30} height={30} />
              </button>
            </div>
          </div>
        </div>
