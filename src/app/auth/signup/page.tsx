...
const Signup = () => {
  return (
    ...
    <Slogan />
      <div className='flex text-center flex-col items-center gap-5 w-2/4 max-md:w-full p-5'>
        <Image src={purpleLogo} className='w-[170px] h-[38px] max-md:hidden' alt='Amazing' />
        <p>حساب جديد</p>
        <form className='gap-3'>
            <span className='relative'>
                <input type='text' placeholder='الاسم كامل' className='w-3/4 text-[12px] p-3 mb-3 outline-none ' />
            ...
            <span className='relative'>
                <input type='email' placeholder='البريد الالكتروني' className='w-3/4 text-[12px] p-3 mb-3 outline-none ' />
            ...
            <span className='relative'>
                <input type='text' placeholder='رقم الجوال' className='w-3/4 text-[12px] p-3 mb-3 outline-none ' />
            ...
            <span className='relative'>
                <select className="gender mb-3 w-3/4 text-[12px] p-2 outline-none">
            ...
            <span className='custom-date-input relative'>
                <input type='date' placeholder='تاريخ الميلاد' className='w-3/4 text-[12px] p-3 mb-3 outline-none ' />
            </span>
            <span className='relative'>
                <input type='password' placeholder='كلمة المرور' className='w-3/4 text-[12px] p-3 mb-3 outline-none ' />
                <FontAwesomeIcon icon={faEye} className='w-[16px] h-[16px] text-gray-300 absolute left-5 top-2/4 -translate-y-2/4 -translate-x-2/4' />
            </span>
            <input type='submit' value='تسجيل' className='login w-3/4 text-[12px] text-white cursor-pointer p-3 mb-3 outline-none ' />
            ...
            <span>لديك حساب بالفعل؟  <Link className='login-link' href='auth/login'>تسجيل الدخول</Link></span>
        </form>
      </div>
    </div>
  )
