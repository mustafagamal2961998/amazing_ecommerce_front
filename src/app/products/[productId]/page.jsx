          ...
          <div className='flex flex-col gap-5 items-start'>
            ...
            <span className='color flex flex-col gap-2 items-start'>
                  ...
                  <span className='flex items-center gap-2'>
                      <Image src={img1} width={200} height={200} className='rounded-md w-[72px] h-[72px] cursor-pointer' alt={productId.title} />
                      <Image src={img2} width={200} height={200} className='rounded-md w-[72px] h-[72px] cursor-pointer' alt={productId.title} />
                      <Image src={img3} width={200} height={200} className='rounded-md w-[72px] h-[72px] cursor-pointer' alt={productId.title} />
                      <Image src={img4} width={200} height={200} className='rounded-md w-[72px] h-[72px] cursor-pointer' alt={productId.title} />
                  </span>
              </span>
            ...
            <span className='w-[300px] flex flex-col items-start gap-2'>
              <button className='bg-[#5E6DA8] duration-200 hover:bg-[#5e6da8da] text-white p-4 rounded-xl relative w-[154%]'>
                اضف إلى السلة
