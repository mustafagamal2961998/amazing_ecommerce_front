...
const profile = () => {
  ...
  return (
    <div className='min-h-screen'>
        <Navbar />
        <div className='flex gap-20 pl-[60px]'>
            <aside className='w-1/4 min-h-screen flex flex-col justify-start items-center gap-20 p-5 bg-gradient-to-br from-[#252B42] to-[#5E6DA8]'>
            ...
            <section className='w-full h-fit mt-[100px] pb-[60px] bg-[#EDF0FF] rounded-md flex flex-col gap-20'>
                <span className='flex justify-between'>
                    <span className='p-2 w-[12%] text-center bg-[#252B42] text-white rounded-tr-xl rounded-bl-xl'>
                        معلومات الحساب
                    </span>
                ...
                <div className='flex flex-col items-center gap-3 mb-5'>
                    <span className='flex items-center justify-start gap-[300px] bg-white shadow-md rounded-xl text-center w-3/4'>
                        <p className='bg-[#5E6DA8] text-white p-2 rounded-tr-xl rounded-br-xl w-[20%]'>البريد الإلكتروني</p>
                        <p className='font-bold w-[10%]'>a.hassan@amazing.sa</p>
                    </span>
                    <span className='flex items-center justify-start gap-[300px] bg-white shadow-md rounded-xl text-center w-3/4'>
                        <p className='bg-[#5E6DA8] text-white p-2 rounded-tr-xl rounded-br-xl w-[20%]'>رقم الجوال</p>
                        <p className='font-bold w-[10%]'>201554854128+</p>
                    </span>
                    <span className='flex items-center justify-start gap-[300px] bg-white shadow-md rounded-xl text-center w-3/4'>
                        <p className='bg-[#5E6DA8] text-white p-2 rounded-tr-xl rounded-br-xl w-[20%]'>الجنس</p>
                        <p className='font-bold w-[10%]'>ذكر</p>
                    </span>
                    <span className='flex items-center justify-start gap-[300px] bg-white shadow-md rounded-xl text-center w-3/4'>
                        <p className='bg-[#5E6DA8] text-white p-2 rounded-tr-xl rounded-br-xl w-[20%]'>تاريخ الميلاد</p>
                        <p className='font-bold w-[10%]'>2 يناير 1996</p>
                    </span>
                    <span className='flex items-center justify-start gap-[300px] bg-white shadow-md rounded-xl text-center w-3/4'>
                        <p className='bg-[#5E6DA8] text-white p-2 rounded-tr-xl rounded-br-xl w-[20%]'>كلمة المرور</p>
            ...
            <section className='w-full mt-[100px] pb-[60px] flex flex-col gap-5'>
                <span className='flex justify-between w-full'>
                    <h2 className='text-2xl font-bold'>عناوين الشحن</h2>
                ...
                <form className='relative w-full mt-4 bg-[#EDF0FF] rounded-md h-full flex flex-col items-center gap-4 p-5'>
                    <span className='absolute right-0 p-2 bg-[#5E6DA8] text-white w-[10%] rounded-tr-2xl rounded-bl-2xl text-center mt-[-20px]'>
                        عنوان جديد
                    </span>
                    ...
                    <span className='flex items-center  gap-[40px] w-2/4 mt-[30px]'>                
                        <input type='text' placeholder='الاسم الاول' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        <input type='text' placeholder='الاسم الاخير' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                    </span>
                    <span className='flex items-center gap-[40px] w-2/4'>
                        <input type='text' placeholder='رقم الجوال' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        <input type='text' placeholder='رقم جوال اضافي' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                    </span>
                    <input type='text' placeholder='العنوان' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-2/4' />
                    <input type='text' placeholder='تفاصيل أكثر حول العنوان' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-2/4' />
                    <span className='flex items-center gap-[40px] w-2/4'>
                        <input type='text' placeholder='المنطقة' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        <input type='text' placeholder='المدينة' className='p-2 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                    </span>
                    <span className='flex items-center gap-3 w-1/4'>
                        <input type='submit' value='حفظ' className='bg-[#5E6DA8]  hover:bg-[#5e6da8e3] duration-200 p-2 rounded-xl text-white cursor-pointer outline-none w-2/4' />
                        <button className='bg-[#F24747]  hover:bg-[#f24747d2] duration-200 p-2 rounded-xl text-white outline-none w-2/4'>إلغاء</button>
                    </span>
                </form>
                <h2 className='text-2xl font-bold'>عناوين مسجلة</h2>
            ...
            <section className='w-full mt-[100px] pb-[60px] flex flex-col gap-5'>
                <span className='flex justify-between w-full'>
                    <h2 className='text-2xl font-bold'>بطاقات الإئتمان</h2>
                    <span className='flex items-center gap-2 ml-2 cursor-pointer rounded-2xl bg-[#5E6DA8] p-2 mt-6'>
                        <Image src={addLocation} className='w-[24px] h-[24px]' alt='Amazing' />
                ...
                <form className='relative w-full mt-4 bg-[#EDF0FF] rounded-md h-full flex flex-col items-center gap-4 p-5'>
                    ...
                    <span className='relative w-3/4 mt-[30px]'>
                        ...
                        <input type='text' placeholder='1234 1234 1234 1234' className='placeholder:absolute placeholder:left-5 p-3 mb-4 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full mt-[30px]' />
                    ...
                    <span className='flex items-center gap-3 w-3/4'>
                        <span className='relative w-2/4'>                    
                            ...
                            <input type='text' placeholder='MM / YY' className='placeholder:absolute placeholder:left-5 p-3 mt-[18px] mb-[16px] rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        </span>
                        <span className='relative w-2/4'>                    
                            <p className='absolute left-0 top-[-15px] text-[#4F5B76]'>CVV</p>
                            <input type='text' placeholder='CVV' className='placeholder:absolute placeholder:left-5 p-3 mt-[18px] mb-[16px] rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        </span>
                    </span>
                    <span className='flex flex-row-reverse items-center gap-3 w-3/4'>
                        ...
                        <span className='relative w-2/4'>                    
                            ...
                            <input type='text' className='p-3 mt-[18px] mb-[16px] rounded-xl outline-none w-full' />
                        </span>
                    </span>
                    <input type='submit' value='حفظ' className='bg-[#5E6DA8] p-3 rounded-xl text-white cursor-pointer outline-none w-3/4' />
                </form>
                <h2 className='text-2xl font-bold'>بطاقات مسجلة</h2>
                <div className='relative flex justify-between p-5 w-full bg-[#EDF0FF] rounded-2xl'>
            ...
            mode === 'shop' &&
            <section className='w-full mt-[100px] pb-[60px] flex flex-col gap-5'>
                <h2 className='text-2xl font-bold'>خزانتي</h2>
                <HomePage />
            </section>
            }
            {
