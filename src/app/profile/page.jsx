...
const profile = () => {
  ...
  return (
    <div className='flex gap-20 pl-[60px] min-h-screen'>
        <aside className='w-1/4 flex flex-col justify-start items-center gap-20 p-5 bg-gradient-to-br from-[#252B42] to-[#5E6DA8]'>
