...
const profile = () => {
  ...
  return (
    <div className='flex items-start gap-20 h-screen pl-[60px]'>
        ...
        {mode === 'information' &&
        <section className='w-full mt-[100px] pb-[60px] bg-[#EDF0FF] rounded-md h-fit flex flex-col gap-20'>
            ...
            <div className='flex flex-col items-center gap-3 mb-5'>
                <span className='flex items-center justify-start gap-[300px] bg-white shadow-md rounded-md text-center w-3/4'>
