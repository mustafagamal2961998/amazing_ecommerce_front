...
const profile = () => {
  ...
  return (
    <div className='min-h-screen'>
        <Navbar />
        <div className='relative flex gap-20 md:pl-[60px] max-md:p-5'>
            ...
            {mode === 'information' &&
            <section className={`w-full ${sidebar ? 'max-md:hidden' : ''} h-fit mt-[100px] pb-[60px] bg-[#EDF0FF] rounded-md flex flex-col gap-20`}>
            ...
            {mode === 'location' &&
            <section className={`w-full ${sidebar ? 'max-md:hidden' : ''} mt-[100px] pb-[60px] flex flex-col gap-5`}>
            ...
            <section className={`w-full ${sidebar ? 'max-md:hidden' : ''} mt-[100px] pb-[60px] flex flex-col gap-5`}>
                ...
                <form className='relative w-full mt-4 bg-[#EDF0FF] rounded-md h-full flex flex-col items-center gap-4 p-5'>
                    ...
                    <span className='relative w-3/4 mt-[30px]'>
                        ...
                        <input type='text' placeholder='1234 1234 1234 1234' className='placeholder:absolute placeholder:left-5 p-3 max-md:p-2 max-md:placeholder:text-xs mb-4 rounded-xl placeholder:text-[#E7E7E7] outline-none w-full mt-[30px]' />
                    ...
                    <span className='flex items-center gap-3 w-3/4'>
                        <span className='relative w-2/4'>                    
                            ...
                            <input type='text' placeholder='MM / YY' className='placeholder:absolute placeholder:left-5 p-3 max-md:p-2 max-md:placeholder:text-xs mt-[18px] mb-[16px] rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        </span>
                        <span className='relative w-2/4'>                    
                            <p className='absolute left-0 top-[-15px] text-[#4F5B76]'>CVV</p>
                            <input type='text' placeholder='CVV' className='placeholder:absolute placeholder:left-5 p-3 max-md:p-2 max-md:placeholder:text-xs mt-[18px] mb-[16px] rounded-xl placeholder:text-[#E7E7E7] outline-none w-full' />
                        </span>
                    </span>
                    <span className='flex flex-row-reverse items-center gap-3 w-3/4'>
                        ...
                        <span className='relative w-2/4'>                    
                            ...
                            <input type='text' className='p-3 max-md:p-2 max-md:placeholder:text-xs mt-[18px] mb-[16px] rounded-xl outline-none w-full' />
                        </span>
                    </span>
            ...
            {
            mode === 'favourite' &&
            <section className={`fav-products w-full ${sidebar ? 'max-md:hidden' : ''} flex flex-col items-start gap-5 p-10 favourite-products`}>
